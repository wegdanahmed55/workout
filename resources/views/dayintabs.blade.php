<html>
    <head>
        ...
        <link rel="stylesheet" href="./css/dayintabs.css">
    ...
    <body>
        ...
        <div class="chooseaday">
            ...
            <div class="day">
            <p>Day1</p>
            <a href="{{url('/day1intabs')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day2</p>
            <a href="{{url('/day2intabs')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day3</p>
            <a href="{{url('/day3intabs')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day4</p>
            <a href="{{url('/day4intabs')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day5</p>
            <a href="{{url('/day5intabs')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day6</p>
            <a href="{{url('/day6intabs')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
             <p>Day7</p>
             <a href="{{url('/day7intabs')}}"><i class="fas fa-chevron-right"></i></a>  
            </div>
        </div>
