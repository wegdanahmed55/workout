<html>
    <head>
        ...
        <link rel="stylesheet" href="./css/daybegabs.css">
    ...
    <body>
        ...
        <div class="chooseaday">
            ...
            <div class="day">
            <p>Day1</p>
            <a  href="{{url('/day1begabs')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day2</p>
            <a  href="{{url('/day2begabs')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day3</p>
            <a  href="{{url('/day3begabs')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day4</p>
            <a  href="{{url('/day4begabs')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day5</p>
            <a  href="{{url('/day5begabs')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day6</p>
            <a  href="{{url('/day6begabs')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
             <p>Day7</p>
             <a  href="{{url('/day7begabs')}}"><i class="fas fa-chevron-right"></i></a>  
            </div>
        </div>
