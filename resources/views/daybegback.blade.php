<html>
    <head>
        ...
        <link rel="stylesheet" href="./css/daybegback.css">
    ...
    <body>
        ...
        <div class="chooseaday">
            ...
            <div class="day">
            <p>Day1</p>
            <a href="{{url('/day1begback')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day2</p>
            <a href="{{url('/day2begback')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day3</p>
            <a href="{{url('/day3begback')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day4</p>
            <a href="{{url('/day4begback')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day5</p>
            <a href="{{url('/day5begback')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day6</p>
            <a href="{{url('/day6begback')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
             <p>Day7</p>
             <a href="{{url('/day7begback')}}"><i class="fas fa-chevron-right"></i></a>  
            </div>
        </div>
