<html>
    <head>
        ...
        <link rel="stylesheet" href="./css/daybegleg.css">
    ...
    <body>
        ...
        <div class="chooseaday">
            ...
            <div class="day">
            <p>Day1</p>
            <a href="{{url('/day1begleg')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day2</p>
            <a href="{{url('/day2begleg')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day3</p>
            <a href="{{url('/day3begleg')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day4</p>
            <a href="{{url('/day4begleg')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day5</p>
            <a href="{{url('/day5begleg')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day6</p>
            <a href="{{url('/day6begleg')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
             <p>Day7</p>
             <a href="{{url('/day7begleg')}}"><i class="fas fa-chevron-right"></i></a>  
            </div>
        </div>
