<html>
    <head>
        ...
        <link rel="stylesheet" href="./css/dayintarm.css">
    ...
    <body>
        ...
        <div class="chooseaday">
            ...
            <div class="day">
            <p>Day1</p>
            <a href="{{url('/day1intarm')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day2</p>
            <a href="{{url('/day2intarm')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day3</p>
            <a href="{{url('/day3intarm')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day4</p>
            <a href="{{url('/day4intarm')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day5</p>
            <a href="{{url('/day5intarm')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
            <p>Day6</p>
            <a href="{{url('/day6intarm')}}"><i class="fas fa-chevron-right"></i></a>
            </div>
            <div class="day">
             <p>Day7</p>
             <a href="{{url('/day7intarm')}}"><i class="fas fa-chevron-right"></i></a>  
            </div>
        </div>
